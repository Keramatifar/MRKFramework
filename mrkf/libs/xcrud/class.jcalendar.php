<?php
  ...
  Class jCalendar {
    ...
    */
    ...
    public function getdate_timestamp($timestamp=null) {
      $temp = $this->getdate();
    ...
    */
    public function date($format, $stamp=null, $GMT=null) {
      //      echo "=$stamp= <br> =$GMT= <br>";
      //$GMT = isset($GMT) ? $GMT : date("Z");
//      $timezone = date("T");
//      if($timezone == 'IRDT')
//        $stamp = isset($stamp) ? ($stamp-3600) : (time()-3600);
//      elseif ($timezone == 'IRST')
//        $stamp = isset($stamp) ? ($stamp) : (time());
//      else
//        $stamp = isset($stamp) ? ($stamp+$GMT) : (time()+$GMT);
      //           echo "=$stamp= <br> =$GMT= <br> =$timezone=<br>";
      //     $stamp = isset($stamp) ? ($stamp) : (time());
      //     echo "=$stamp= <br> =$GMT= <br>";
      $formatArr = array(
...
//      echo "<hr/>";
  ...
  */
  ...
  Class parsDate extends jCalendar {}
  Class parsCal extends jCalendar {}
  ?>