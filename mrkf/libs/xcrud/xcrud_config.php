...
{
    // default connection
    public static $dbname = DB_DATABASE; // Your database name
    public static $dbuser = DB_USERNAME; // Your database username
    public static $dbpass = DB_PASSWORD; // // Your database password
    public static $dbhost = DB_SERVER; // Your database host, 'localhost' is default.
    ...
    public static $db_time_zone = TIMEZONE; // database time zone, if you want use system default - leave empty.
    ...
    public static $sess_expire = 1200; // Specifies the lifetime of the session, as well as the existence of a key safety (for example, the maximum edit-saving timeout).
    ...
    // scripts
    public static $load_bootstrap = 0; // turn on, if you want to load bootstrap via xCRUD
    public static $load_googlemap = 0; // loads google map api for 'POINT' type. Turn off, if your site already uses it.
    public static $load_jquery = 1; // loads jQuery, turn it off if you already have jQuery on your page. jQuery version must be at least 1.7. If your jQuery loads in the bottom of page, you must activate $manual_load and use  Xcrud::load_css() & Xcrud::load_js() on your page.
    ...
    public static $jquery_no_conflict = 1; // Includes jQuery.noConflict(). Use according to jQuery documentation.
    public static $manual_load = 0; // Allows you to disable xcruds css and js output, but you can use Xcrud::load_css() & Xcrud::load_js() in your code manually.

    
    // editor
    public static $editor_url = '/assets/editors/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js'; // URL path to editor script, if you want to use the visual editor.include("/[FTP:akord] /plugins/ckeditor/ckeditor.js");
    //public static $editor_url = 'editors/tinymce/tinymce.min.js'; // URL path to editor script, if you want to use the visual editor.
    //public static $editor_url = 'plugins/ckeditor/ckeditor.js';
    //public static $editor_init_url = 'plugins/ckeditor/init.js'; //  URL path to your custom initialization file for editor.
    public static $editor_init_url = '/assets/editors/bootstrap-wysihtml5/init.js'; //  URL path to your custom initialization file for editor.
    ...
    public static $fixed_action_buttons = false; // it allows to fix the action buttons on the right side of the table. Appears when you hover on row.
    ...
    public static $upload_folder_def = '../../../cache'; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
    ...
    // alert settings
    public static $email_from = 'info@barnamenevis.co'; // email from address
    public static $email_from_name = 'yomobit Data Management System'; // email from name
    public static $email_enable_html = true; // enables html in email letters

    
    // remote request options (call_page() methods)
    public static $use_browser_info = true; // allow to use your browser cookie, referer, user agent for http request to some file or url. BE CAREFUL: DON'T USE IT FOR REQUESTS TO EXTERNAL SITES!!!
    ...
    // map
    public static $default_point = '35.6810912,51.4015082';
    ...
    public static $default_search_text = 'نام محله تان را وارد کنید';
