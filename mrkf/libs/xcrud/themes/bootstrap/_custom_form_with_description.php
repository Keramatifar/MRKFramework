            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="box box-primary box-solid">
                        <div class="box-header with-border ">
                            <h3 class="box-title">کلاس ارسال</h3>
                        </div>
                        <div class="box-body"><?=$this->fields_output['product.shipping_class']['field'];?></div>
                    </div>
                </div>
            </div>
        </div>
...
echo $treeSample->treeResult;
        ...
        <div class="box box-success">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <?=$this->fields_output['product.sport_id']['field'];?>
            </div>
            <!-- /.box-body -->
            <div class="box-footer">
